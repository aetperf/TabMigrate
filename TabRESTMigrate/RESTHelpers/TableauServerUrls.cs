...
class TableauServerUrls : ITableauServerSiteInfo
{
    ...
    public TableauServerUrls(string protocol, string serverName, string siteUrlSegment, int pageSize, ServerVersion serverVersion)
    {
        ...
        this.UrlLogin                              = serverNameWithProtocol + "/api/3.2/auth/signin";
        this.UrlLogout                             = serverNameWithProtocol + "/api/3.2/auth/signout";
        this._urlListWorkbooksForUserTemplate      = serverNameWithProtocol + "/api/3.2/sites/{{iwsSiteId}}/users/{{iwsUserId}}/workbooks?pageSize={{iwsPageSize}}&pageNumber={{iwsPageNumber}}";
        this._urlListWorkbookConnectionsTemplate   = serverNameWithProtocol + "/api/3.2/sites/{{iwsSiteId}}/workbooks/{{iwsWorkbookId}}/connections";
        this._urlListDatasourcesTemplate           = serverNameWithProtocol + "/api/3.2/sites/{{iwsSiteId}}/datasources?pageSize={{iwsPageSize}}&pageNumber={{iwsPageNumber}}";
        this._urlListProjectsTemplate              = serverNameWithProtocol + "/api/3.2/sites/{{iwsSiteId}}/projects?pageSize={{iwsPageSize}}&pageNumber={{iwsPageNumber}}";
        this._urlListSubscriptionsTemplate         = serverNameWithProtocol + "/api/3.2/sites/{{iwsSiteId}}/subscriptions?pageSize={{iwsPageSize}}&pageNumber={{iwsPageNumber}}";
        this._urlListSchedulesTemplate             = serverNameWithProtocol + "/api/3.2/schedules?pageSize={{iwsPageSize}}&pageNumber={{iwsPageNumber}}";
        this._urlListTasksInScheduleTemplate       = serverNameWithProtocol + "/api/3.2/sites/{{iwsSiteId}}/schedules/{{iwsScheduleId}}/extracts?pageSize={{iwsPageSize}}&pageNumber={{iwsPageNumber}}";
        this._urlListViewsTemplate                 = serverNameWithProtocol + "/api/3.2/sites/{{iwsSiteId}}/views?includeUsageStatistics=true&pageSize={{iwsPageSize}}&pageNumber={{iwsPageNumber}}";
        this._urlListGroupsTemplate                = serverNameWithProtocol + "/api/3.2/sites/{{iwsSiteId}}/groups?pageSize={{iwsPageSize}}&pageNumber={{iwsPageNumber}}";
        this._urlListUsersTemplate                 = serverNameWithProtocol + "/api/3.2/sites/{{iwsSiteId}}/users?pageSize={{iwsPageSize}}&pageNumber={{iwsPageNumber}}";
        this._urlListUsersInGroupTemplate          = serverNameWithProtocol + "/api/3.2/sites/{{iwsSiteId}}/groups/{{iwsGroupId}}/users?pageSize={{iwsPageSize}}&pageNumber={{iwsPageNumber}}"; 
        this._urlDownloadDatasourceTemplate        = serverNameWithProtocol + "/api/3.2/sites/{{iwsSiteId}}/datasources/{{iwsRepositoryId}}/content";
        this._urlDownloadWorkbookTemplate          = serverNameWithProtocol + "/api/3.2/sites/{{iwsSiteId}}/workbooks/{{iwsRepositoryId}}/content";
        this._urlSiteInfoTemplate                  = serverNameWithProtocol + "/api/3.2/sites/{{iwsSiteId}}";
        this._urlInitiateUploadTemplate            = serverNameWithProtocol + "/api/3.2/sites/{{iwsSiteId}}/fileUploads";
        this._urlAppendUploadChunkTemplate         = serverNameWithProtocol + "/api/3.2/sites/{{iwsSiteId}}/fileUploads/{{iwsUploadSession}}";
        this._urlFinalizeUploadDatasourceTemplate  = serverNameWithProtocol + "/api/3.2/sites/{{iwsSiteId}}/datasources?uploadSessionId={{iwsUploadSession}}&datasourceType={{iwsDatasourceType}}&overwrite=true";
        this._urlFinalizeUploadWorkbookTemplate    = serverNameWithProtocol + "/api/3.2/sites/{{iwsSiteId}}/workbooks?uploadSessionId={{iwsUploadSession}}&workbookType={{iwsWorkbookType}}&overwrite=true";
        this._urlCreateProjectTemplate             = serverNameWithProtocol + "/api/3.2/sites/{{iwsSiteId}}/projects";
        this._urlDeleteWorkbookTagTemplate         = serverNameWithProtocol + "/api/3.2/sites/{{iwsSiteId}}/workbooks/{{iwsWorkbookId}}/tags/{{iwsTagText}}";
        this._urlDeleteDatasourceTagTemplate       = serverNameWithProtocol + "/api/3.2/sites/{{iwsSiteId}}/datasources/{{iwsDatasourceId}}/tags/{{iwsTagText}}";
        this._urlUpdateWorkbookTemplate            = serverNameWithProtocol + "/api/3.2/sites/{{iwsSiteId}}/workbooks/{{iwsWorkbookId}}";
        this._urlUpdateDatasourceTemplate          = serverNameWithProtocol + "/api/3.2/sites/{{iwsSiteId}}/datasources/{{iwsDatasourceId}}";
